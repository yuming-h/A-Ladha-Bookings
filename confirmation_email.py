...
class ConfirmationEmail:
    ...
    def send_confirmation(self):
        ...
        sol_body = """\
            ...
            <div class="gmail_default">
            <div class="gmail_default">
            <p>Please note that the booking time includes setup and cleanup&nbsp;as managed by your organization,&nbsp;and all furniture and equipment must be returned to their original locations.<span style="color: #000000;">&nbsp;</span><span style="color: #000000;"><em>If the cleanup is not done properly, a $200.00 deposit will be charged and you may risk losing booking privileges at the ALSSC in the future.</em></span>&nbsp;There will be an Event Supervisor present during the duration of your booking should you have any questions, concerns, or technical issues.&nbsp;</p>
            <p>&nbsp;</p>
            <p>In this email, I have attached the&nbsp;Premises&nbsp;Use and Services Agreement&nbsp;and&nbsp;Rental Terms and Conditions&nbsp;documents, which need to be signed and&nbsp;scanned&nbsp;back to me 2 weeks prior to the event date,&nbsp;via&nbsp;email. Your booking qualifies as an&nbsp;<strong>"""+self.response.booking_type+"""&nbsp;</strong>and the total rental fee is outlined in the attached invoice&nbsp;(excluding the Deposit).&nbsp;The $200.00 building damage fee will be charged should any damages be made after the event.&nbsp;</p>
            <div>&nbsp;</div>
            </div>
            </div>
            </div>
